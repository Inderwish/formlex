...
随包资料包括 419 条有具体出处的专业术语，以及 855 条常规原创灵感和独立的 150 条网站特色；自定义内容按用户当前说明使用，不自动套用专业资料。每个常规维度可用 dimensionLibraries 单独选择来源，未覆盖项沿用 libraryId。分类依据内容与出处人工维护，不按名称或加入时间推断。
